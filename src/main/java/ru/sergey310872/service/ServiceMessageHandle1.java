...
public class ServiceMessageHandle1 {
    ...
    SourceKafkaConsumer1 sourceKafkaConsumer;
    SinkKafkaProducer sinkKafkaProducer;
    Properties properties;

    public ServiceMessageHandle1() {
        this.sourceKafkaConsumer = new SourceKafkaConsumer1();
        this.sinkKafkaProducer = new SinkKafkaProducer();
        this.properties = PropertiesFile.PROP;
    }

    public ServiceMessageHandle1(Properties properties) {
        this.sourceKafkaConsumer = new SourceKafkaConsumer1();
        this.sinkKafkaProducer = new SinkKafkaProducer();

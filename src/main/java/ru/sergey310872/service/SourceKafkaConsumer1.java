...
public class SourceKafkaConsumer1 implements Source {
    private KafkaConsumer<String, SourceMessage> consumer;
    private final Random random = new Random();
    private final Logger LOGGER = LoggerFactory.getLogger(this.getClass());

    public SourceKafkaConsumer1() {
        this.consumer = new KafkaConsumerConfig1().getConsumer();
    }
    public SourceKafkaConsumer1(KafkaConsumer<String, SourceMessage> consumer) {
